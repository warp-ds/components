...
export const standard = () => <TextArea label="Description" helpText="Hint message" />;

export const valueUncontrolled = () => <TextArea label="Description" defaultValue="Test" />;
...
export const placeholder = () => <TextArea label="Description" placeholder="Lorem ipsum" />;
...
export const minimumRows3 = () => <TextArea label="Description" minimumRows={3} />;

export const maximumRows3 = () => <TextArea label="Description" maximumRows={3} />;
